...
public:
  ...
  void drawModel(cv::Mat &image, cv::Scalar color = cv::Scalar(0, 0, 255));
...
private:
  ...
  void drawModel(std::vector<cv::Point2f> &courtPoints, cv::Mat &image, cv::Scalar color = cv::Scalar(0, 0, 255));
